...
\item \large{Director del proyecto: Juan José Domínguez Jiménez}
\item \large{Autor del proyecto: Daniel Ignacio Salazar Recio}
\end{itemize}
...
\begin{flushright}
  ...
  \large{Fdo: Daniel Ignacio Salazar Recio}
\end{flushright}
