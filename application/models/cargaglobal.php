...
class CargaGlobal extends Doctrine_Record {
    public function setTableDefinition() {
        ...
        $this -> hasColumn('num_semanas', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true));
        $this -> hasColumn('horas_teoria', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('grupos_teoria', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('horas_problemas', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('grupos_problemas', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('horas_informatica', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('grupos_informatica', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('horas_lab', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('grupos_lab', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
        $this -> hasColumn('horas_campo', 'integer', 4, array('type' => 'integer', 'length' => 4, 'fixed' => false, 'unsigned' => true, ));
